...
/**
 * Lightweight inline-SVG icon set (Feather-style, MIT). Bundled — no CDN, so it
 * works offline and inside the Capacitor APK. Stroke uses currentColor.
 */
@Component({
  selector: 'app-icon',
  standalone: true,
  template: `
    ...
    >
      @switch (name) {
        ...
        @case ('edit') { <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" /> }
        @case ('trash') {
